The GitHub repository [Thayumanavan007/VBNPROJECT](https://github.com/Thayumanavan007/VBNPROJECT.git) hosts a Python-based application designed to facilitate voice-based note-taking and memo management.
